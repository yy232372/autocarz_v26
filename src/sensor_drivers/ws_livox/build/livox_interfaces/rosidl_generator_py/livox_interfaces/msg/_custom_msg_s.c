...
bool livox_interfaces__msg__custom_point__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * livox_interfaces__msg__custom_point__convert_to_py(void * raw_ros_message);

ROSIDL_GENERATOR_C_EXPORT
bool livox_interfaces__msg__custom_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("livox_interfaces.msg._custom_msg.CustomMsg", full_classname_dest, 42) == 0);
  }
  livox_interfaces__msg__CustomMsg * ros_message = _ros_message;
  {  // header
  ...
  {  // points
    ...
    if (!livox_interfaces__msg__CustomPoint__Sequence__init(&(ros_message->points), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create livox_interfaces__msg__CustomPoint__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    livox_interfaces__msg__CustomPoint * dest = ros_message->points.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!livox_interfaces__msg__custom_point__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
PyObject * livox_interfaces__msg__custom_msg__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("livox_interfaces.msg._custom_msg");
  ...
  {  // points
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = livox_interfaces__msg__custom_point__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
