...
livox_interfaces__msg__CustomMsg__create(void)
{
...
livox_interfaces__msg__CustomMsg__Sequence__init(livox_interfaces__msg__CustomMsg__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(livox_interfaces__msg__CustomMsg)) {
      return false;
    }
  ...
  livox_interfaces__msg__CustomMsg__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(livox_interfaces__msg__CustomMsg)) {
      return false;
    }
